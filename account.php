...
<body>
    <header class="header">
        ...
        <div class="user_profile">
            <div class="user_info">
                <img src="<?php echo $_SESSION['avatarPath']?>" alt="Фото користувача">
                <h2><?php echo $_SESSION['name'] . " " . $_SESSION['surname']?></h2>
            </div>

            <div class="nav_buttons">
                <div class="accbutton">
                    <a href="/shedule.php"><i class="fa-regular fa-calendar-days"></i><br>Розклад</a>
                </div>

                <div class="accbutton">
                    <a href="/lesson.php"><i class="fa-solid fa-chalkboard"></i><br>Урок</a>
                </div>

                <div class="accbutton">
                    <a href="/training.php"><i class="fa-brands fa-leanpub"></i><br>Навчання</a>
                </div>
            </div>
        </div>
