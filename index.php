        ...
        <div class="container">
            ...
            <div class="header_row">
                <div class="header_content">
                    <div class="header_bage">Вивчай математику разом з нами</div>
                    <h1 class="header_title">MathTutor - Школа онлайн навчання</h1>
                    <div class="header_text">
                        <p>На нашому сайті діти откримують якісні знання!</p>
                    </div>
                    <a class="header_button" href="tutors.php">Обрати вчителя</a>
                </div>

                <div class="header_img">
                    <img src="img/tutorheader.png" alt="">
                </div>
            </div>
        </div>
